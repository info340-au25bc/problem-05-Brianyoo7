...
function huskiesLost(game) {
  // If UW was home, compare home_score to opponent_score
  if (game.home === "UW") {
    return game.home_score < game.opponent_score;
  } else {
    // If UW was the opponent, compare opponent_score to home_score
...
lostGames.forEach(function(game) {
  // Determine the format based on who was home
  if (game.home === "UW") {
    console.log(game.opponent + " at " + game.home + ", " + game.opponent_score + " to " + game.home_score);
  } else {
    console.log(game.home + " at " + game.opponent + ", " + game.home_score + " to " + game.opponent_score);
  }
});
...
function mostYardsPassing(game1, game2) {
  // If game1 has no passing_yards property, return game2
  if (game1.passing_yards === undefined) {
    return game2;
  }
  // Otherwise, return the game with more passing yards
